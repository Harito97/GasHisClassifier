...
def save_history(history):
    ...
    com.to_csv("history_efficientnet_ver1.csv", index=False)
...
def plot_history(history):
    ...
    plt.savefig("model_accuracy_loss_efficientnet_ver1.png")
    plt.show()
...
x = base_model(Inp)
# x = Conv2D(512, (1, 1), activation="relu")(x)  # Sử dụng Conv2D để giảm số lượng đặc trưng xuống 512
...
# finetuned_model.load_weights('/mnt/DataK/Project/GasHisCancer/PatchLevel_GasHisSDB/efficientnet_best.keras')
