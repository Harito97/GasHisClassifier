...
DATA_DIR = 'D:/Projects/GasHisClassifier/Data/datav2'
TARGET_SIZE = (64, 64)
BATCH_SIZE = 12 * 20
...
def save_history(history):
    ...
    com.to_csv("history1_datav2.csv", index=False)
...
def plot_history(history):
    ...
    plt.savefig("model_accuracy_loss_datav2.png")
    plt.show()
...
# finetuned_model.load_weights('D:/Projects/GasHisClassifier/TrainModel/VGG/vgg_best_datav2.keras')
